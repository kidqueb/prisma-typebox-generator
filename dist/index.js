...
(0, _generatorHelper.generatorHandler)({
  ...
  async onGenerate(options) {
    var _options$generator$ou, _options$generator$ou2;
    const payload = (0, _transformDMMF.transformDMMF)(options.dmmf);
    const outputDir = (_options$generator$ou = (_options$generator$ou2 = options.generator.output) === null || _options$generator$ou2 === void 0 ? void 0 : _options$generator$ou2.value) !== null && _options$generator$ou !== void 0 ? _options$generator$ou : './typebox';
    try {
